...
export const walkWorlds = [
  {
    ...
    role: "2015 — present",
    location: "Maldives · remote-friendly",
    description:
      "Software engineer shipping production web products. PHP since 2015; now React, Next.js, Laravel, Node.js, and PHP at Centurion PLC.",
    achievement: "A decade from PHP foundations to end-to-end product engineering.",
    bullets: [
      "BSCS, AWKUM University, 2015–2019.",
      "Full-stack delivery with React, Next.js, Laravel, Node.js, and PHP.",
      "TEDxAlBateen appreciation award for the event platform — registrations, speakers, and live coordination in Laravel and Vue.js.",
      "Google Ads for Irfan Towing (67% more qualified leads) and Meeraj Towing (45% more leads, ~60% better conversion).",
    ],
  ...
  },
  {
    ...
    location: "Islamabad, Pakistan",
    description:
      "Full-stack PHP at Aursoft — React, Laravel, CodeIgniter, Ext-Sencha, and large production user bases.",
    achievement: "10+ web apps on AWS with 99.9% uptime; API time down ~30% and release cycles shorter by 40%.",
    bullets: [
      "Full-stack PHP with React, Laravel, CodeIgniter, Ext-Sencha, PostgreSQL, and MySQL.",
      "Designed and deployed 10+ web applications; ran AWS EC2, S3, and RDS with 99.9% uptime.",
      "Cut API response time by about 30% and automated deploys, shortening release cycles by 40%.",
    ...
    stack: ["React", "Laravel", "PostgreSQL", "AWS"],
    rgb: [111, 184, 198],
    start: 3380,
    end: 4880,
    href: "https://www.aursoft.com/",
    ask: {
      prompt: "What improved in delivery?",
      options: [
        { label: "Faster APIs and automated deploys", ok: true },
        { label: "A native mobile store", ok: false },
      ],
      reveal: "AWS-hosted PHP and React apps — 99.9% uptime, ~30% faster APIs.",
    },
  },
  {
    key: "islog",
    ...
    location: "Remote, Türkiye",
    description:
      "Backend engineering at Ferisoft — Laravel, Node.js, Express, Firebase, and REST APIs.",
    achievement: "Third-party integrations ~25% faster; 5+ full-stack apps with ~30% better runtime efficiency.",
    bullets: [
      "Backend engineering with Laravel, Node.js, Express, Firebase, PostgreSQL/MySQL, and REST APIs.",
      "Integrated third-party services and cut system integration time by about 25%.",
      "Shipped 5+ full-stack PHP, JavaScript, and MySQL applications and improved runtime efficiency by about 30%.",
    ...
    href: "https://www.ferisoft.com/",
    ask: {
      prompt: "What was the engineering focus?",
      options: [
  ...
  },
  {
    ...
    location: "Fujairah, UAE",
    description:
      "Product-based full-stack work at Fujtown LLC — React, Next.js, Laravel, and PHP across live directory and booking platforms.",
    achievement: "Inventory accuracy +35%, downtime about −15%, production bugs about −30%.",
    bullets: [
      "Product-based full-stack work with React, Next.js, Tailwind, Laravel, CodeIgniter, PostgreSQL, and MySQL.",
      "Shipped directory and booking products for a large live user base in Fujairah, including fujtown.com.",
      "Built a custom inventory system that improved stock-tracking accuracy by 35%.",
    ...
    href: "https://www.fujtown.com/",
    ask: {
      prompt: "What products went live?",
      options: [
        { label: "Directory and booking products", ok: true },
        { label: "Native iOS apps only", ok: false },
      ],
      reveal: "Laravel + Vue directory plus booking products: listings, search, auth, roles.",
    },
  },
  {
    key: "monoomoi",
    ...
    location: "Maldives",
    description:
      "Full-stack engineer at Centurion PLC since July 2026 — production web platforms after the Fujtown handover.",
    achievement: "Owning end-to-end delivery on live platforms: UI, APIs, deploys, performance, and SEO.",
    bullets: [
      "Joined Centurion PLC in July 2026 to own full-stack delivery on live web platforms.",
      "Building features end to end with React, Next.js, Laravel, and PHP — UI, APIs, and deploys.",
      "Focused on performance, SEO, and keeping production systems reliable after the Fujtown handover.",
  ...
  },
  {
    ...
    description:
      "Open for full-stack product work. Contact form, email, or WhatsApp — I reply as soon as I can.",
    achievement: "The next chapter starts with a conversation.",
    bullets: [
      `Email ${site.email}`,
      "Contact form on this site, or WhatsApp for a shorter note.",
      "Résumé and selected work are one click away.",
    ],
    ...
    href: "/contact",
    ask: {
      prompt: "Fastest way to reach me?",
      options: [
...
export const careerSkills = [
  ...
  { year: "2026", skill: "Production delivery", x: 8520 },
